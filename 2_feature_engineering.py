...
#
matches = pd.read_csv('C:\\Users\\ASUS\\Desktop\\3.º ano\\2.º  semestre\\IAP\\proj\\dataset.csv', parse_dates=['date'])
matches.iloc[0]
...
matches.to_csv('C:\\Users\\ASUS\\Desktop\\3.º ano\\2.º  semestre\\IAP\\proj\\features_dataset.csv', index=False)
